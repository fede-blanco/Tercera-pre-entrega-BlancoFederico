...
#! Se agrega una cadena de forma aleatoria --> Es la llave para la seguridad de toda la aplicación
# podria guardarse en un archivo( fuera de project) donde no se esté ejecutando la aplicación e importarla
...
# * Se podria hacer algo similar con aplicaciones de terceros
# INSTALLED_APPS += [
#     "xxxx",
#     "xxxx",
# ]
